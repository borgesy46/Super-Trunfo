...
int main() {
    ...
    super_poder1 = (float)populacao1 + area_km2_1 + (pib_bilhoes1 * 1000000000) + (float)pontos_turisticos1 + pib_per_capita1 + (1.0 / densidade_populacional1);
 
    super_poder2 = (float)populacao2 + area_km2_2 + (pib_bilhoes2 * 1000000000) + (float)pontos_turisticos2 + pib_per_capita2 + (1.0 / densidade_populacional2);
